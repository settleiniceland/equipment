...
public interface MaintainDetailMapper extends BaseMapperX<MaintainDetailDO> {
    ...
    default PageResult<MaintainDetailDO> selectPage(MaintainDetailPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<MaintainDetailDO>()
                ...
                .eqIfPresent(MaintainDetailDO::getEquiplocationId, reqVO.getEquiplocationId())
                .likeIfPresent(MaintainDetailDO::getEquiplocationName, reqVO.getEquiplocationName())
                .likeIfPresent(MaintainDetailDO::getEquipprofileIds, reqVO.getEquipprofileIds())
                .likeIfPresent(MaintainDetailDO::getEquipprofileCodes, reqVO.getEquipprofileCodes())
