package cn.newness.imip.module.infra.controller.admin.codegen;
...
import cn.newness.imip.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.newness.imip.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.newness.imip.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.newness.imip.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.newness.imip.module.infra.convert.codegen.CodegenConvert;
...
import cn.newness.imip.module.infra.service.codegen.CodegenService;
...
import static cn.newness.imip.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "newness"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "新奇")
    })
