package cn.newness.imip.module.infra.framework.file.core.utils;
...
public class FileTypeUtils {
    ...
    public static String getMineType(BufferedInputStream data, String name) throws IOException {
        return TIKA.get().detect(data, name);
    }
