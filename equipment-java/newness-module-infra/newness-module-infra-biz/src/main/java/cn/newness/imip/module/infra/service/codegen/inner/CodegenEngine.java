package cn.newness.imip.module.infra.service.codegen.inner;
...
import cn.newness.imip.framework.apilog.core.enums.OperateTypeEnum;
import cn.newness.imip.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.newness.imip.framework.common.util.date.LocalDateTimeUtils;
import cn.newness.imip.framework.common.util.object.BeanUtils;
import cn.newness.imip.framework.common.util.object.ObjectUtils;
import cn.newness.imip.framework.common.util.string.StrUtils;
import cn.newness.imip.framework.excel.core.annotations.DictFormat;
import cn.newness.imip.framework.excel.core.convert.DictConvert;
...
import cn.newness.imip.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.newness.imip.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.newness.imip.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.newness.imip.module.infra.enums.codegen.CodegenSceneEnum;
import cn.newness.imip.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import cn.newness.imip.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    void initGlobalBindingMap() {
        ...
        globalBindingMap.put("DataPermissionDOClassName", DataPermissionDO.class.getName());
        globalBindingMap.put("baseDOFields", CodegenBuilder.BASE_DO_FIELDS);
        globalBindingMap.put("dataPermissionDOFields",CodegenBuilder.DATA_PERMISSION_DO_FIELDS);
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "newness-module-${table.moduleName}/" + // 顶级模块
                "newness-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "newness-module-${table.moduleName}/" + // 顶级模块
                "newness-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "newness-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "newness-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
