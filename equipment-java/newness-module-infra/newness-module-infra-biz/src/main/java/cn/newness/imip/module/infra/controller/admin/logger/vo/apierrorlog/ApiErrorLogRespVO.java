package cn.newness.imip.module.infra.controller.admin.logger.vo.apierrorlog;
...
import cn.newness.imip.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cn.newness.imip.module.system.enums.DictTypeConstants.USER_TYPE)
