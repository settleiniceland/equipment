...
import cn.newness.imip.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import cn.newness.imip.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link cn.newness.imip.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    public static final Set<String> BASE_DO_FIELDS = new HashSet<>();
    public static final Set<String> DATA_PERMISSION_DO_FIELDS = new HashSet<>();
    /**
     * 新增操作，不需要传递的字段
     */
    ...
    static {
        ...
        Arrays.stream(ReflectUtil.getFields(DataPermissionDO.class)).forEach(field -> DATA_PERMISSION_DO_FIELDS.add(field.getName()));
