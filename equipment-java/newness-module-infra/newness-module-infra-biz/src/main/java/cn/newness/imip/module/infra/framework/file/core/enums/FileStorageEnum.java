package cn.newness.imip.module.infra.framework.file.core.enums;
...
import cn.newness.imip.module.infra.framework.file.core.client.db.DBFileClient;
import cn.newness.imip.module.infra.framework.file.core.client.db.DBFileClientConfig;
import cn.newness.imip.module.infra.framework.file.core.client.ftp.FtpFileClient;
import cn.newness.imip.module.infra.framework.file.core.client.ftp.FtpFileClientConfig;
import cn.newness.imip.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.newness.imip.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.newness.imip.module.infra.framework.file.core.client.s3.S3FileClient;
import cn.newness.imip.module.infra.framework.file.core.client.s3.S3FileClientConfig;
import cn.newness.imip.module.infra.framework.file.core.client.sftp.SftpFileClient;
