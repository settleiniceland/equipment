...
public interface AdminUserService {
    ...
    /**
    * 对“获取登录用户的权限信息”功能做个service层包装【用于管理端与移动端公用】
    *
    * @param []
    * @author machuran
    * @date 9/1/2024
    * @Return cn.newness.imip.module.system.controller.admin.auth.vo.AuthPermissionInfoRespVO
    */
    AuthPermissionInfoRespVO getPermissionInfo();
    /**
    * 对“获得登录用户信息”功能做一个包装【供管理端与app端共同使用】
    *
    * @param []
    * @author machuran
    * @date 9/1/2024
    * @Return cn.newness.imip.module.system.controller.admin.user.vo.profile.UserProfileRespVO
    */
    UserProfileRespVO getUserProfile();
}
