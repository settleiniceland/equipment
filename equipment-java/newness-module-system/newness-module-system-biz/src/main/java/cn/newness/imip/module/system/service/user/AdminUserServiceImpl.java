package cn.newness.imip.module.system.service.user;
...
import cn.newness.imip.framework.common.exception.ServiceException;
...
import cn.newness.imip.framework.datapermission.core.util.DataPermissionUtils;
...
import cn.newness.imip.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.newness.imip.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.newness.imip.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.newness.imip.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.newness.imip.module.system.convert.auth.AuthConvert;
import cn.newness.imip.module.system.convert.user.UserConvert;
...
import cn.newness.imip.module.system.dal.dataobject.dept.UserPostDO;
import cn.newness.imip.module.system.dal.dataobject.permission.MenuDO;
import cn.newness.imip.module.system.dal.dataobject.permission.RoleDO;
import cn.newness.imip.module.system.dal.dataobject.social.SocialUserDO;
import cn.newness.imip.module.system.dal.dataobject.user.AdminUserDO;
import cn.newness.imip.module.system.dal.mysql.dept.UserPostMapper;
...
import cn.newness.imip.module.system.service.permission.MenuService;
import cn.newness.imip.module.system.service.permission.PermissionService;
import cn.newness.imip.module.system.service.permission.RoleService;
import cn.newness.imip.module.system.service.social.SocialUserService;
...
import static cn.newness.imip.framework.common.util.collection.CollectionUtils.convertList;
...
import static cn.newness.imip.module.system.enums.ErrorCodeConstants.*;
import static cn.newness.imip.module.system.enums.LogRecordConstants.*;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:newnessyuanma}")
    ...
    public AuthPermissionInfoRespVO getPermissionInfo() {
        // 1.1 获得用户信息
        AdminUserDO user = getUser(getLoginUserId());
        if (user == null) {
            return null;
        }
    ...
    public UserProfileRespVO getUserProfile() {
        ...
        return UserConvert.INSTANCE.convert(user, userRoles, dept, posts, socialUsers);
    }
