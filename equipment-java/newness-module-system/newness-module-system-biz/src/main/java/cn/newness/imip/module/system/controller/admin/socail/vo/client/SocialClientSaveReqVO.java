package cn.newness.imip.module.system.controller.admin.socail.vo.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "newness商城")
