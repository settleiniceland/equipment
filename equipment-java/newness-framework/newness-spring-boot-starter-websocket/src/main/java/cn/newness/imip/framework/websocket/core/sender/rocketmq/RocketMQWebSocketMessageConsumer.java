package cn.newness.imip.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${newness.websocket.sender-rocketmq.topic}",
        consumerGroup = "${newness.websocket.sender-rocketmq.consumer-group}",
