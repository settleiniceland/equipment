package cn.newness.imip.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import cn.hutool.extra.servlet.ServletUtil;
import cn.newness.imip.framework.common.enums.TerminalEnum;
...
public class WebFrameworkUtils {
    ...
    private static final String REQUEST_ATTRIBUTE_LOGIN_USER_DEPT_ID = "login_user_dept_id";
     ...
     * 终端的 Header
     *
     * @see cn.newness.imip.framework.common.enums.TerminalEnum
     */
    ...
    * @Return void
    */
    public static void setDeptId(ServletRequest request, Long deptId){
        request.setAttribute(REQUEST_ATTRIBUTE_LOGIN_USER_DEPT_ID,deptId);
    }
    /**
    * 从请求中获取用户部门id
    *
    ...
    */
    public static Long getDeptId(HttpServletRequest request){
        ...
        return (Long) request.getAttribute(REQUEST_ATTRIBUTE_LOGIN_USER_DEPT_ID);
    }
}
