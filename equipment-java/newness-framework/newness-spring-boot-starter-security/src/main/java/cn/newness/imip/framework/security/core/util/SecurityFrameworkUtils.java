package cn.newness.imip.framework.security.core.util;
...
public class SecurityFrameworkUtils {
    ...
    public static void setLoginUser(LoginUser loginUser, HttpServletRequest request) {
        ...
        WebFrameworkUtils.setLoginUserName(request,loginUser.getUserName());
        WebFrameworkUtils.setDeptId(request,loginUser.getDeptId());
    }
