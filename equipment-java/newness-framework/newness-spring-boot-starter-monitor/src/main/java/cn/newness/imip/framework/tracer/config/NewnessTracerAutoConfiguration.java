...
import cn.newness.imip.framework.tracer.core.aop.BizTraceAspect;
import cn.newness.imip.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "newness.tracer", value = "enable", matchIfMissing = true)
public class NewnessTracerAutoConfiguration {
