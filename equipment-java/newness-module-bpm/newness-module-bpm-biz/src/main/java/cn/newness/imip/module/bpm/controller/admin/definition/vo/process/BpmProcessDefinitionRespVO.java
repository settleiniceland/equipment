package cn.newness.imip.module.bpm.controller.admin.definition.vo.process;
...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "新奇")
    private String name;

    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "newness")
    private String key;

    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/newness.jpg")
    private String icon;
