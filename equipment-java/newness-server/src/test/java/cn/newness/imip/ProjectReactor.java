...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.newness.boot";
    private static final String ARTIFACT_ID = "newness";
    private static final String PACKAGE_NAME = "cn.newness.imip";
    private static final String TITLE = "newness管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.newness.boot";
        String artifactIdNew = "newness";
        String packageNameNew = "cn.newness.imip";
        String titleNew = "newness管理系统";
        String projectBaseDirNew = "C:/Users/26484/Desktop/nowProject/equipmentManagement"; // 一键改名后，“新”项目所在的目录
