  ...
  <div class="panel-tab__content">
    ...
    <el-dialog :visible.sync="propertyFormModelVisible" title="属性配置" width="600px" append-to-body destroy-on-close>
      ...
      <template slot="footer">
        <el-button size="mini" @click="propertyFormModelVisible = false">{{ $t("message.Button.cancel") }}</el-button>
        <el-button size="mini" type="primary" @click="saveAttribute">{{ $t("message.Button.determine") }}</el-button>
      </template>
    </el-dialog>
  </div>
</template>
