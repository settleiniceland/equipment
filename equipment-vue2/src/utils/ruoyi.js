...
/** 
 * 更自由地转换数据结构公用函数【可以传入属性名了】
 * @author mcr
 */
export const myNormalizer = (node,customId,customLabel) => {
...
/** 
 * treeSelect选中后查找选中了tree对象
 * @param {*} nodes 树型元数据【数组】
 * @param {*} id 树形结构选中的id
 * @returns 选中id对应的树型数据
 * @author mcr
 */
 ...
 * @author mcr
 */
export const handleTreeForString = (data, id, parentId, children) => {
