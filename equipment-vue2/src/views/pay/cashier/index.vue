  ...
  <div class="app-container">
    ...
    <el-card v-loading="loading">
      <el-descriptions title="支付信息" :column="3" border>
        ...
        <el-descriptions-item :label='$t("message.Button.createTime")'>{{ parseTime(payOrder.createTime) }}</el-descriptions-item>
    ...
    <el-dialog :title="barCode.title" :visible.sync="barCode.visible" width="500px" append-to-body
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="barCode.visible = false">{{ $t("message.Button.cancel") }}</el-button>
      </div>
    </el-dialog>
  </div>
</template>
