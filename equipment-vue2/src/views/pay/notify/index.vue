<template>
  <div class="app-container">
    ...
    <el-dialog title="通知详情" :visible.sync="open" width="700px" v-dialogDrag append-to-body>
      ...
      <el-descriptions :column="2" label-class-name="desc-label">
        <el-descriptions-item :label='$t("message.Button.createTime")'>{{ parseTime(notifyDetail.createTime) }}</el-descriptions-item>
        <el-descriptions-item :label='$t("message.Button.updateTime")'>{{ parseTime(notifyDetail.updateTime) }}</el-descriptions-item>
      </el-descriptions>
      <!-- 分割线 -->
      <el-divider />
