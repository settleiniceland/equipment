<template>
  <div class="app-container">
    ...
    <el-dialog title="订单详情" :visible.sync="open" width="700px" v-dialogDrag append-to-body>
      ...
      <el-descriptions :column="2" label-class-name="desc-label">
        <el-descriptions-item :label='$t("message.Button.createTime")'>{{ parseTime(orderDetail.createTime) }}</el-descriptions-item>
        <el-descriptions-item :label='$t("message.Button.updateTime")'>{{ parseTime(orderDetail.updateTime) }}</el-descriptions-item>
      </el-descriptions>
      <!-- 分割线 -->
      <el-divider/>
      <el-descriptions :column="2" label-class-name="desc-label">
