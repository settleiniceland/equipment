<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column :label='$t("message.Button.operation")' align="center" fixed="right" class-name="small-padding fixed-width">
        <template v-slot="scope">
    ...
    <el-dialog title="退款订单详情" :visible.sync="open" width="700px" v-dialogDrag append-to-body>
      ...
      <el-descriptions :column="2" label-class-name="desc-label">
        <el-descriptions-item :label='$t("message.Button.createTime")'>{{ parseTime(refundDetail.createTime) }}</el-descriptions-item>
        <el-descriptions-item :label='$t("message.Button.updateTime")'>{{ parseTime(refundDetail.updateTime) }}</el-descriptions-item>
      </el-descriptions>
      <!-- 分割线 -->
      <el-divider />
      <el-descriptions :column="2" label-class-name="desc-label">
