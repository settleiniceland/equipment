<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column :label='$t("message.Button.operation")' align="center" width="450" fixed="right">
        <template v-slot="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['bpm:model:delete']">{{ $t("message.Button.del") }}</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <el-dialog title="导入流程" :visible.sync="upload.open" width="400px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="uploadClose">{{ $t("message.Button.cancel") }}</el-button>
      </div>
    </el-dialog>
