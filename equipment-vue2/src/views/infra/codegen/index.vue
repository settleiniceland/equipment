<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList">
      ...
      <el-table-column label="表名称" align="center" prop="tableName" width="180"/>
      <el-table-column label="表描述" align="center" prop="tableComment" :show-overflow-tooltip="true" width="400"/>
      <el-table-column label="实体" align="center" prop="className" width="180"/>
      <el-table-column :label='$t("message.Button.createTime")' align="center" prop="createTime" width="140">
        <template v-slot="scope">
          <span>{{ parseTime(scope.row.createTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column :label='$t("message.Button.updateTime")' align="center" prop="createTime" width="140">
        <template v-slot="scope">
          <span>{{ parseTime(scope.row.updateTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column :label='$t("message.Button.operation")' align="center" width="300px" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button type="text" size="small" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['infra:codegen:delete']">{{ $t("message.Button.del") }}</el-button>
