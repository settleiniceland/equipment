<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeList">
      ...
      <el-table-column :label='$t("message.Button.creator")' align="center" prop="createBy" width="100"/>
      <el-table-column :label='$t("message.Button.createTime")' align="center" prop="createTime" width="100">
        <template v-slot="scope">
