<template>
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                       v-hasPermi="['system:user:create']">{{ $t("message.Button.add") }}</el-button>
          </el-col>
          <el-col :span="1.5">
          ...
          <el-col :span="1.5">
            <el-button type="warning" icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                       v-hasPermi="['system:user:export']">{{ $t("message.Button.export") }}</el-button>
          </el-col>
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column :label='$t("message.Button.createTime")' align="center" prop="createTime" v-if="columns[6].visible" width="160">
            <template v-slot="scope">
              <span>{{ parseTime(scope.row.createTime) }}</span>
            </template>
          </el-table-column>
          <el-table-column :label='$t("message.Button.operation")' align="center" width="160" class-name="small-padding fixed-width">
            <template v-slot="scope">
              <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                         v-hasPermi="['system:user:update']">{{ $t("message.Button.update") }}</el-button>
              <el-dropdown  @command="(command) => handleCommand(command, scope.$index, scope.row)"
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleDelete" v-if="scope.row.id !== 1" size="mini" type="text" icon="el-icon-delete"
                                    v-hasPermi="['system:user:delete']">{{ $t("message.Button.del") }}</el-dropdown-item>
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitFileForm">{{ $t("message.Button.determine") }}</el-button>
        <el-button @click="upload.open = false">{{ $t("message.Button.cancel") }}</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog title="分配角色" :visible.sync="openRole" width="500px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitRole">{{ $t("message.Button.determine") }}</el-button>
        <el-button @click="cancelRole">{{ $t("message.Button.cancel") }}</el-button>
      </div>
    </el-dialog>
