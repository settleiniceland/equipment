<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="warning" icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['system:operate-log:export']">{{ $t("message.Button.export") }}</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column :label='$t("message.Button.operation")' align="center" width="60" class-name="small-padding fixed-width">
        <template v-slot="scope">
